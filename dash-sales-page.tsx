  ...
  return (
    <div className="min-h-screen">
      ...
      >
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <img
            ...
            className="h-16 -my-4"
          />
          <Button className="bg-white text-slate-800 hover:bg-gray-100 rounded-full px-6 py-2" asChild>
      ...
      <section className="py-20 px-4 bg-slate-50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-slate-900">DASH — The AI Coach That Never Misses a Rep</h2>
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              Every one of these is a real coach that would cost you $100+ per session.
              <br />
              With DASH, you get all of them for the price of a single session.
              <br />
              <span className="italic">Stop paying for expensive coaching.</span>
            </p>
          </div>
            ...
            {[
              {
                ...
                improvement: "Added 18cm to my vert in only 14 days.",
                content:
                  "I dropped 0.3 seconds off my 100m time in just 4 weeks. The form analysis showed me exactly what I was doing wrong with my start.",
                rating: 5,
                avatar: "MJ",
                image:
              ...
              },
              {
                ...
                improvement: "Cut 0.32s off 100m in 3 weeks",
                content:
                  "The personalized training plan helped me break my 5K PR by over 30 seconds. I finally understand my running efficiency.",
                rating: 5,
                avatar: "SK",
              ...
              },
              {
                ...
                improvement: "Improved 100m hurdles by 0.4s",
                content:
                  "As someone who runs recreationally, I never thought I needed coaching. DASH proved me wrong - I'm faster and injury-free.",
                rating: 5,
                avatar: "DR",
              ...
              },
              {
                ...
                improvement: "PR'd by 45cm in 1 month",
                content:
                  "The biomechanical analysis was incredible. I could see exactly where I was losing power in my stride. Game changer!",
                rating: 5,
                avatar: "EL",
